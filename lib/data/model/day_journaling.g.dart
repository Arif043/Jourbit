...
void _dayJournalingSerialize(
  ...
  writer.writeInt(offsets[1], object.dayCheck?.index);
...
DayJournaling _dayJournalingDeserialize(
  ...
  object.dayCheck =
      _DayJournalingdayCheckValueEnumMap[reader.readIntOrNull(offsets[1])];
...
P _dayJournalingDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_DayJournalingdayCheckValueEnumMap[reader.readIntOrNull(offset)])
          as P;
    case 2:
...
extension DayJournalingQueryWhereSort
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension DayJournalingQueryWhere
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause>
      dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateEqualTo(
      DateTime? date) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'date',
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateNotEqualTo(
      DateTime? date) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateGreaterThan(
    DateTime? date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateLessThan(
    DateTime? date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DayJournaling, DayJournaling, QAfterWhereClause> dateBetween(
    DateTime? lowerDate,
    DateTime? upperDate, {
    bool includeLower = true,
    bool includeUpper = true,
