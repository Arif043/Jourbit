...
const HabitSchema = CollectionSchema(
  ...
  properties: {
    r'checkBoxValues': PropertySchema(
      id: 0,
      name: r'checkBoxValues',
...
int _habitEstimateSize(
  ...
  {
    final value = object.checkBoxValues;
    if (value != null) {
...
void _habitSerialize(
  ...
  writer.writeBoolList(offsets[0], object.checkBoxValues);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.checkBoxValues = reader.readBoolList(offsets[0]);
  object.id = id;
...
extension HabitQueryWhere on QueryBuilder<Habit, Habit, QWhereClause> {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'checkBoxValues',
      ));
    });
  }

  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      checkBoxValuesElementEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'checkBoxValues',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'checkBoxValues',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      checkBoxValuesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> checkBoxValuesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByCheckBoxValues() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'checkBoxValues');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<bool>?, QQueryOperations> checkBoxValuesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'checkBoxValues');
    });
  }
